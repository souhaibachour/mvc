...
use EtudBundle\Entity\Etudiant;
...
class EtudiantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $etudiants = $em->getRepository('EtudBundle:Etudiant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EtudBundle\Form\EtudiantType', $etudiant);
    ...
    {
        $deleteForm = $this->createDeleteForm($etudiant);
        $editForm = $this->createForm('EtudBundle\Form\EtudiantType', $etudiant);
